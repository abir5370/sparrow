            ...
            @foreach($categories as $category)
                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-4">
                    <div class="cats_side_wrap text-center mx-auto mb-3">
                        <div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-4 circle mb-2 border"><a href="javascript:void(0);" class="d-block"><i style="font-size: 30px;width:70px;height:70px;line-height:70px;" class="{{$category->icon}}"></i></a></div></div>
                        ...
                        <div class="product_grid row">
                            <div class="col-xl-4 col-lg-5 col-md-5 col-4">
                                <div class="shop_thumb position-relative">
                                    <a class="card-img-top d-block overflow-hidden" href="{{ route('details',$best_product->rel_to_product->slug) }}"><img class="card-img-top" src="{{ asset('uploads/product/preview/'.$best_product->rel_to_product->preview) }}" alt="..."></a>
                                </div>
                            </div>
                            <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                                <div class="text-left mfliud">
                                    <div class="elso_titl"><span class="small">{{ $best_product->rel_to_product->rel_to_category->name }}</span></div>
                                    <h5 class="fs-md mb-0 lh-1 mb-1 ft-medium"><a href="{{ route('details',$best_product->rel_to_product->slug) }}">{{ $best_product->rel_to_product->product_name }}</a></h5>
                                    <div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
                                        @php
                                    ...
                                    <div class="elis_rty">
                                        @if($best_product->rel_to_product->discount != null)
                                             <span class="ft-bold text-muted line-through fs-sm mr-2">BDT{{ $best_product->rel_to_product->price }}</span>
                                        @endif
                                        <span class="ft-bold text-muted fs-sm"> BDT{{ $best_product->rel_to_product->after_discount }}</span>
                ...
                <div class="ftr-content">
                    ...
                    @foreach ($resent_viewed_product as $resent_product)
                        <div class="product_grid row">
                            ...
                            <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                                <div class="text-left mfliud">
                                    <div class="elso_titl"><span class="small">{{ $resent_product->rel_to_category->name }}</span></div>
                                    <h5 class="fs-md mb-0 lh-1 mb-1 ft-medium"><a href="{{ route('details',$resent_product->slug) }}">{{ $resent_product->product_name }}</a></h5>
                                    <div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
                                        @php
